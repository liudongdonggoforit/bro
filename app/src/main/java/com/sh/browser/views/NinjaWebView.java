    ...
    private WebViewClient client = new WebViewClient() {
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
            ...
            if (!sp.getBoolean(context.getString(R.string.sp_cookies), true)) {
                ...
                if (getCookieHosts().isWhite(url)) {
                    com.tencent.smtt.sdk.CookieManager manager = com.tencent.smtt.sdk.CookieManager.getInstance();
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
            if (!white && adBlock.isAd(request.getUrl().toString())) {
                return new WebResourceResponse(
                        BrowserUnit.MIME_TYPE_TEXT_PLAIN,
                        BrowserUnit.URL_ENCODING,
                        new ByteArrayInputStream("".getBytes())
            ...
            if (!sp.getBoolean(context.getString(R.string.sp_cookies), true)) {
                ...
                if (getCookieHosts().isWhite(request.getUrl().toString())) {
                    com.tencent.smtt.sdk.CookieManager manager = com.tencent.smtt.sdk.CookieManager.getInstance();
